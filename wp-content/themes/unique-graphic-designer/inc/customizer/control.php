 ...
 */
class Unique_Graphic_Designer_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-graphic-designer' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-graphic-designer-customize-controls' );
		wp_enqueue_script( 'unique-graphic-designer-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Graphic_Designer_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
