 ...
 * @since 1.0.0
 */
class Unique_Graphic_Designer_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'unique_graphic_designer';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'unique-graphic-designer' ), $i ),
...
// Initialize.
$Unique_Graphic_Designer_Footer_Widgets = new Unique_Graphic_Designer_Footer_Widgets();